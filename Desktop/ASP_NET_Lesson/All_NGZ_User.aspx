<%@ Page Language="C#" AutoEventWireup="true" CodeFile="All_NGZ_User.aspx.cs" Inherits="All_NGZ_User" %>
...
<body>
        ...
        <div class="navbar-header"> <a class="navbar-brand" style="margin-left: 120px; color: white;"" href="#">未关注的微博用户列表</a></div>
        ...
        <asp:GridView ID="GridView1" style="margin:0 auto;" OnRowCommand="GridView1_RowCommand" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" RowStyle-Height="20px" Width="55%" Font-Size="15pt">
            <Columns>
                ...
                <asp:TemplateField ShowHeader="False">
                    <ItemTemplate>
                        <asp:LinkButton ID="btn_GZ" runat="server" Text="关注" CommandName="btn_GZ" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"userN").ToString()%>' />
                    </ItemTemplate>
                </asp:TemplateField>
