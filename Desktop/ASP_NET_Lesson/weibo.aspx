    ...
    <div class="mymain" >
        <form id="form1" runat="server">
            ...
            <div style="float:right; width:28%;margin-left:10px">
                ...
                <div class="panel panel-primary" style="margin-top: 10px; border: 0px solid #56b8ff;width:100%;text-align:center">
                    <div class="panel-body" style="width: 100%; text-align: center; padding: 0px">

                        <asp:Label ID="Label2" runat="server" Text="关注的用户" class="list-group-item" Style="background-color: #56b8ff; color: white;width:100%"></asp:Label>
                        <asp:DataList ID="DataList1" runat="server" Style="width: 100%; text-align: center">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" Width="100%" class="list-group-item" runat="server" Text='<%#Eval("target_userN")%>' NavigateUrl='<%#Eval("target_userN","weibo_user.aspx?id={0}") %>'></asp:HyperLink>
                            </ItemTemplate>
                        </asp:DataList>
                ...
                <br />
                <div class="panel panel-primary" style="border: 0px solid #56b8ff;width:100%">
                    <div class="panel-body" style="width: 100%; text-align: center; padding: 0px">

                        <asp:Label ID="Label3" runat="server" Text="点赞最多" class="list-group-item" Style="background-color: #56b8ff; color: white;width:100%"></asp:Label>
                        <asp:DataList ID="DataList5" runat="server" Style="width: 100%; text-align: center">
                            <ItemTemplate>

                                <asp:LinkButton ID="HyperLink2" Width="100%" class="list-group-item" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"wContent").ToString().Substring(0,5)+numZ%>'>
                ...
                <ContentTemplate>
                    ...
                    <div class="panel panel-primary" style="margin-top: 10px; width: 70%; float: left; border: 0px solid #56b8ff;">
                        <div class="panel-body">
                            ...
                            <div class="form-group" style="padding: 10px;">
                                ...
                                <br />
                                <br />
                                <asp:TextBox ID="TextBox1" class="form-control" runat="server" Height="69px" TextMode="MultiLine" MaxLength="140" Width="100%"></asp:TextBox>
                                <br />
                    ...
                    <div style="width: 70%; float:left;border: 0px solid #56b8ff;">
                        <div style="background-color: #e8e8e8;width:100%">
                            <asp:Label ID="Label6" runat="server" Text="最新微博" Style="width: 100%; background-color: #56b8ff; color: white; margin-top: 0" class="list-group-item"></asp:Label>


                            <asp:DataList ID="DataList3" runat="server" Width="100%" Height="35px" OnItemCommand="DataList3_ItemCommand" OnItemDataBound="DataList3_ItemDataBound" BackColor="#e8e8e8" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" ForeColor="Black">
                                    ...
                                    <div class="list-group-item" style="padding-left: 150px; padding-right: 150px; margin-bottom: 10px; width: 100%">
                                        ...
                                        <div class="row">
                                            <div class="input-group">
                                                <asp:TextBox ID="txt_P" runat="server" class="form-control" Width="100%"></asp:TextBox>
...
<footer style="float:left;clear:left;width:100%;height:1px;background-color:#e8e8e8;margin-bottom:0" >
    <nav class="navbar navbar-default" style="background-color: #56b8ff; top: 0px; left: 0px; height: 49px;" role="navigation">
        <div class="navbar-header"> <a class="navbar-brand" style="margin-left: 120px; color: white;"" href="#">heyunfan</a></div>
