...
public partial class All_GZ_User : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Page.IsPostBack == false)
        {
            ...
            mytb1 = myADO1.GetTablePRO("sel_user_guanzhu", ref myParam);
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        myADO1.ExecuteNonQueryPro("update_user_not_guanzhu", ref myParam);
        Response.Redirect("All_GZ_User.aspx");
    }
}